...
- win-iem-snv (iem.lan / 10.77.9.231)
- win-stream-snv (10.77.9.204)
- win-mbc-snv (mbc.lan)
- win-print-client (print-client.lan)
- win-print-server (print-server.lan)
- win-pz-server (10.88.1.100)
- win-pz-snv (10.78.2.10)
- win-pjpos (10.78.5.10)
- win-pz-holla (10.88.1.105)

### New macOS machine
- mac-propresenter (10.77.9.203), macOS 15.6 Sequoia, Apple Silicon (arm64), Python 3.9.6
...
- Windows servers: `win-*` prefix (e.g., `win-pz-snv`)
- macOS servers: `mac-*` prefix (e.g., `mac-propresenter`)
...
2. Test on Mac ProPresenter (10.77.9.203) — install.sh, verify tools
...
First macOS deployment: mac-propresenter at 10.77.9.203 (SSH: newlevel@10.77.9.203)
